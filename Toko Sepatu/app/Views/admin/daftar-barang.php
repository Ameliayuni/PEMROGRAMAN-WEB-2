...
<head>
    ...
    <style>
        * {
        ...
        .logout {
            background:hsl(229, 65.80%, 43.50%);
            color: white;
            border: none;
            padding: 10px 20px;
            border-radius: 8px;
        ...
        tr:hover {
            background:hsl(210, 53.00%, 54.90%);
        }
        ...
        .action-buttons button:first-child {
            background:hsl(145, 63.70%, 57.80%);
            color: white;
        }

        .btn-hapus {
            background:hsl(253, 52.90%, 37.50%);
            color: white;
        }
        ...
        .btn-tambah {
            ...
            background: linear-gradient(135deg,rgb(100, 127, 201) 0%, #27ae60 100%);
            color: white;
            text-decoration: none;
            padding: 12px 24px;
            border-radius: 8px;
